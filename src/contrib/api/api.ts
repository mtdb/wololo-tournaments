...
export const ApiApiFetchParamCreator = function(_configuration?: Configuration) {
  return {
    ...
    /**
     *
     * @param {number} id A unique integer value identifying this game.
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     */
    gamesRead(id: number, options: any = {}): FetchArgs {
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          'id',
          'Required parameter id was null or undefined when calling gamesRead.'
        );
      }
      const localVarPath = `/api/games/{id}/`.replace(`{${'id'}}`, encodeURIComponent(String(id)));
      const localVarUrlObj = url.parse(localVarPath, true);
      const localVarRequestOptions = Object.assign({ method: 'GET' }, options);
      const localVarHeaderParameter = {} as any;
      const localVarQueryParameter = {} as any;
...
export const ApiApiFp = function(configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    gamesList(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
      const localVarFetchArgs = ApiApiFetchParamCreator(configuration).gamesList(options);
    ...
    gamesRead(
      ...
      const localVarFetchArgs = ApiApiFetchParamCreator(configuration).gamesRead(id, options);
      return (fetch: FetchAPI = portableFetch, basePath: string = BASE_PATH) => {
        return fetch(basePath + localVarFetchArgs.url, localVarFetchArgs.options).then(response => {
          if (response.status >= 200 && response.status < 300) {
            return response;
...
export const ApiApiFactory = function(
  ...
  return {
    ...
    gamesList(options?: any) {
      return ApiApiFp(configuration).gamesList(options)(fetch, basePath);
    },
    /**
     *
     * @param {number} id A unique integer value identifying this game.
     ...
     * @throws {RequiredError}
     */
    gamesRead(id: number, options?: any) {
      return ApiApiFp(configuration).gamesRead(id, options)(fetch, basePath);
    },
    /**
     *
     * @param {Data} [data]
...
export class ApiApi extends BaseAPI {
  ...
  public gamesList(options?: any) {
    return ApiApiFp(this.configuration).gamesList(options)(this.fetch, this.basePath);
  }
   ...
   * @memberof ApiApi
   */
  public gamesRead(id: number, options?: any) {
    return ApiApiFp(this.configuration).gamesRead(id, options)(this.fetch, this.basePath);
  }
